...
async def process_start_command(message: types.Message):
	...
	await message.answer_video(
		video="https://te.legra.ph/file/c8f2c77939b28e9626159.mp4", 
		caption='<b>😸 Welcome to my feedback bot, You may contact with me\n▫️ <b>If you have idea for new module or need smth send me</b>\n▫️ Please read /nometa</b>',
		parse_mode= 'HTML',
		reply_markup=markup
	)
